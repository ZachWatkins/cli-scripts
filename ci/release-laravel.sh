#!/usr/bin/env bash
# This is an exact copy of Laravel's release file which includes helpful validation steps and automatically pushes the release to each component's dedicated repository.
# I will extend and generalize this at some point to be more useful for my purposes, but for now I am putting it here as-is due to lack of time.
# Source: https://github.com/laravel/framework/blob/9.x/bin/release.sh
set -e

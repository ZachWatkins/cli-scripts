#!/usr/bin/env bash
# Source: https://github.com/bcit-ci/CodeIgniter/blob/develop/build-release.sh
# This file is a copy from CodeIgniter's source code.
# At some point I will take what is being done here and apply it to a new and more generic release script more suitable for my purposes.
